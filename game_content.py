...
# Названия медалей раньше были одинаковым Бронза/Серебро/Золото/Платина на
# ВСЕХ пяти дорожках сразу — голос, который ничего не говорит рядом с
# «Фабрика №9»/«Искажение»/«Странник» (SLAYER Red Team, A5 Voice/Copy: V1
# voice charter, V4 anti-cliché — общий олимпийский шаблон обнуляет весь
# остальной тёмно-оккультный тон именно там, где новичок видит его чаще
# всего — на первой же грядке/крафте с первого дня). Пороги и награды не
# трогаем — только текст, который видит игрок; каждая дорожка получила
# СВОЙ ряд титулов по теме действия, без пересечения со титулами Алтаря
# (Послушник Алтаря/Хранитель Пламени/Жрец Искажения/Вечный — те эндгейм,
# эти видны с первого дня).
FARM_MEDALS = [(1, "🥉 Первая Смена", 25), (10, "🥈 Верный Работник", 75), (50, "🥇 Мастер Цеха", 140), (250, "💎 Легенда Фабрики №9", 250)]

CRAFT_MEDALS = [(1, "🥉 Первая Скрутка", 25), (10, "🥈 Уверенные Руки", 75), (50, "🥇 Мастер Свёртка", 140), (250, "💎 Виртуоз Дыма", 250)]

SMOKE_MEDALS = [(1, "🥉 Первая Затяжка", 25), (10, "🥈 Завсегдатай Дыма", 75), (50, "🥇 Знаток Тумана", 140), (250, "💎 Дитя Искажения", 250)]
