...
# Медали — не обезличенные уровни металла, а маленькие доказательства
# освоенного действия. У каждой петли свой язык прогресса: игрок помнит не
# «дошёл до золота», а то, кем стал в мире Фабрики.
FARM_MEDALS = [
    (1, "🌱 Первый Росток", 25),
    (10, "🌾 Собиратель Урожая", 75),
    (50, "🪴 Садовник Фабрики", 140),
    (250, "💎 Хранитель Грядок", 250),
]

CRAFT_MEDALS = [
    (1, "🧵 Первый Свиток", 25),
    (10, "🌿 Руки Фабрики", 75),
    (50, "🗞️ Мастер Скрутки", 140),
    (250, "💎 Виртуоз Дыма", 250),
]

SMOKE_MEDALS = [
    (1, "💨 Первый След", 25),
    (10, "🌫️ Чтец Дыма", 75),
    (50, "🔥 Проводник Искр", 140),
    (250, "💎 Хозяин Пелены", 250),
]
