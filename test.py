# ============================================================
# ИМПОРТЫ (все явные, без устаревших)
# ============================================================
...
# ============================================================
# КОНТЕКСТ ПРИЛОЖЕНИЯ (замените заглушки на свои классы)
# ============================================================
class AppContext:
    def __init__(self, db_pool, redis_client, cache, settings, repo,
                 war_service, pet_service, achievement_service):
...
class PlayerRepository:
    def __init__(self, pool, redis, cache): pass
class WarConfig: pass
class WarSettings: pass
class GuildWarService:
    def __init__(self, pool, redis, config, settings): pass
class PetService:
    def __init__(self, repo, config): pass
class AchievementService:
    def __init__(self, pool, redis, repo): pass
...
async def background_jobs(ctx: AppContext):
    ...
    # Заглушки – замените на свои реальные функции
    async def keep_db_alive(ctx): pass
...
async def handle_gift_username(update, context): ...
