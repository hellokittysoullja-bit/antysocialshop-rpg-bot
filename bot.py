...
async def top_ru(update: Update, context: ContextTypes.DEFAULT_TYPE): await top(update, context)
async def status_ru(update: Update, context: ContextTypes.DEFAULT_TYPE): await status(update, context)
